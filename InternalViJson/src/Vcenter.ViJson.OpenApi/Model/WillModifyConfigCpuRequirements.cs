...
namespace Vcenter.ViJson.OpenApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WillModifyConfigCpuRequirements")]
    public partial class WillModifyConfigCpuRequirements : MigrationFault, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WillModifyConfigCpuRequirements" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WillModifyConfigCpuRequirements() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WillModifyConfigCpuRequirements" /> class.
        /// </summary>
        /// <param name="typeName">The type discriminator. Refers to the name of a valid data object type.  (required) (default to &quot;WillModifyConfigCpuRequirements&quot;).</param>
        ...
        public WillModifyConfigCpuRequirements(string typeName = @"WillModifyConfigCpuRequirements", MethodFault faultCause = default, List<LocalizableMessage> faultMessage = default) : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WillModifyConfigCpuRequirements {\n");
