...
namespace Vcenter.ViJson.OpenApi.Model
{
    ...
    /// </summary>
    /// <value>This option specifies how to select tasks based on child relationships in the inventory hierarchy.  If a managed entity has children, their tasks can be retrieved with this filter option.  Possible values: - &#x60;self&#x60;: Returns tasks that pertain only to the specified managed entity,   and not its children. - &#x60;children&#x60;: Returns tasks pertaining to child entities only.      Excludes   tasks pertaining to the specified managed entity itself. - &#x60;all&#x60;: Returns tasks pertaining either to the specified managed entity   or to its child entities. </value>
    [JsonConverter(typeof(StringEnumConverter))]
    public enum TaskFilterSpecRecursionOptionEnum
    {
        /// <summary>
