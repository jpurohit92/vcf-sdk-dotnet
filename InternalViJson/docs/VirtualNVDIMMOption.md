# Vcenter.ViJson.OpenApi.Model.VirtualNVDIMMOption
...
**CapacityInMB** | [**LongOption**](LongOption.md) | Minimum and maximum capacity in MB.  | 
**Growable** | **bool** | Option to show if device capacity growth is supported for powered off VMs.  | 
**HotGrowable** | **bool** | Option to show if device capacity growth is supported for powered on VMs.  | 
**GranularityInMB** | **long** | Option to show capacity growth granularity if growth operation is supported in MB.  | 
