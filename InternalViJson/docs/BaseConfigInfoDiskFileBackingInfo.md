# Vcenter.ViJson.OpenApi.Model.BaseConfigInfoDiskFileBackingInfo
...
**ProvisioningType** | **string** | Provisioning type.  See *BaseConfigInfoDiskFileBackingInfoProvisioningType_enum* for the supported types.  | 
