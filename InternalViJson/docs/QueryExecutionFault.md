# Vcenter.ViJson.OpenApi.Model.QueryExecutionFault
This exception is thrown if a failure occurs while processing a query request.  This structure may be used only with operations rendered under `/sms`. 
