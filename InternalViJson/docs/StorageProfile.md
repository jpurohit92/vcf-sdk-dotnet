# Vcenter.ViJson.OpenApi.Model.StorageProfile
...
**NasStorage** | [**List&lt;NasStorageProfile&gt;**](NasStorageProfile.md) | List of NAS storage subprofiles.  Use the *NasStorageProfile.key* property to access a subprofile in the list.  | [optional] 
