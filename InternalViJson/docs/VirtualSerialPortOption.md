# Vcenter.ViJson.OpenApi.Model.VirtualSerialPortOption
...
**YieldOnPoll** | [**BoolOption**](BoolOption.md) | Indicates whether the virtual machine supports the CPU yield option during virtual serial port polling.  When this feature is supported and enabled, the virtual machine will periodically relinquish the processor if its sole task is polling the virtual serial port.  If &lt;code&gt;yieldOnPoll.supported&lt;/code&gt; is &lt;code&gt;false&lt;/code&gt;, the virtual machine ignores the virtual serial port object setting for &lt;code&gt;*VirtualSerialPort.yieldOnPoll*&lt;/code&gt;.  | 
