# Vcenter.ViJson.OpenApi.Model.ServiceConsolePortGroupProfile
...
**IpConfig** | [**IpAddressProfile**](IpAddressProfile.md) | IP address configuration for the service console network.  | 
