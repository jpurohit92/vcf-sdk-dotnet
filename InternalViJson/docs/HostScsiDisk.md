# Vcenter.ViJson.OpenApi.Model.HostScsiDisk
...
**DevicePath** | **string** | The device path of the ScsiDisk.  This device path is a file path that can be opened to create partitions on the disk.  See also *HostStorageSystem.RetrieveDiskPartitionInfo*, *HostStorageSystem.UpdateDiskPartitions*.  | 
...
**PhysicalLocation** | **List&lt;string&gt;** | The physical location of the ScsiDisk if can be determined, otherwise unset.  If the ScsiDisk is a logical drive, it should be the location of all constituent physical drives of the logical drive. If the ScsiDisk is a physical drive, it&#39;s an array of one element.  | [optional] 
**EmulatedDIXDIFEnabled** | **bool** | Indicates whether the ScsiDisk has emulated Data Integrity Extension (DIX) / Data Integrity Field (DIF) enabled.  If unset, the default value is false.  | [optional] 
**VsanDiskInfo** | [**VsanHostVsanDiskInfo**](VsanHostVsanDiskInfo.md) | Indicates the additional VSAN information if this disk is used by VSAN.  | [optional] 
**ScsiDiskType** | **string** | The type of disk drives.  See *ScsiDiskType_enum* for definitions of supported types.  | [optional] 
**UsedByMemoryTiering** | **bool** | Indicate whether the disk is used for memory tiering or not.  If unset, the default value is false.  ***Since:*** vSphere API Release 8.0.3.0  | [optional] 
