# Vcenter.ViJson.OpenApi.Model.VirtualCdromRemotePassthroughBackingOption
...
**Exclusive** | [**BoolOption**](BoolOption.md) | Flag to indicate whether or not exclusive CD-ROM device access is supported.  | 
