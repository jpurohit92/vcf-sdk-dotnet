# Vcenter.ViJson.OpenApi.Model.VsanMountPrecheckNetworkLatencyResult
...
**Details** | [**List&lt;VsanMountPrecheckNetworkLatencyDetail&gt;**](VsanMountPrecheckNetworkLatencyDetail.md) | A list of *VsanMountPrecheckNetworkLatencyDetail*, it contains the network latency result for each client host to the server hosts it mounts to.  | 
