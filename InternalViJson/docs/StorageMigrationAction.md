# Vcenter.ViJson.OpenApi.Model.StorageMigrationAction
...
**Vm** | [**ManagedObjectReference**](ManagedObjectReference.md) | Virtual machine reference.  Refers instance of *VirtualMachine*.  | 
**RelocateSpec** | [**VirtualMachineRelocateSpec**](VirtualMachineRelocateSpec.md) | Specification for moving a virtual machine or a set of virtual disks to a different datastore.  | 
