# Vcenter.ViJson.OpenApi.Model.VirtualMachineScsiPassthroughInfo
...
**ScsiClass** | **string** | The class of the generic SCSI device.  | 
**Vendor** | **string** | The vendor name.  | 
**PhysicalUnitNumber** | **int** | Unit number of the generic device on the physical host.  | 
