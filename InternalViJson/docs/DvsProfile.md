# Vcenter.ViJson.OpenApi.Model.DvsProfile
...
**Name** | **string** | Unique identifier for the distributed virtual switch.  | 
**Uplink** | [**List&lt;PnicUplinkProfile&gt;**](PnicUplinkProfile.md) | List of subprofiles that map physical NICs to uplink ports.  Use the *PnicUplinkProfile.key* property to access subprofiles in the list.  | [optional] 
