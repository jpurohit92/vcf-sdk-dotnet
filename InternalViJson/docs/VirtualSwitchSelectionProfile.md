# Vcenter.ViJson.OpenApi.Model.VirtualSwitchSelectionProfile
The *VirtualSwitchSelectionProfile* data object represents the virtual switch that is connected to a port group.  The *ApplyProfile.policy* property contains the configuration data values for the virtual switch. 
