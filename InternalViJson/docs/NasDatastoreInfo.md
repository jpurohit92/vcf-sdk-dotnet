# Vcenter.ViJson.OpenApi.Model.NasDatastoreInfo
...
**Nas** | [**HostNasVolume**](HostNasVolume.md) | The NFS mount information for the datastore.  May not be available when the datastore is not accessible.  | [optional] 
