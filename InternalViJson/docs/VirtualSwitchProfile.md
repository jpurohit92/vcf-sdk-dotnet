# Vcenter.ViJson.OpenApi.Model.VirtualSwitchProfile
...
**Name** | **string** | Name of the standard virtual switch(VSS).  | 
**Link** | [**LinkProfile**](LinkProfile.md) | Links that are connected to the virtual switch.  | 
**NumPorts** | [**NumPortsProfile**](NumPortsProfile.md) | Number of ports on the virtual switch.  | 
**NetworkPolicy** | [**NetworkPolicyProfile**](NetworkPolicyProfile.md) | Network policy/policies for the virtual switch.  | 
