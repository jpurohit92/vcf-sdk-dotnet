# Vcenter.ViJson.OpenApi.Model.LockerMisconfiguredEvent
...
**Datastore** | [**DatastoreEventArgument**](DatastoreEventArgument.md) | The datastore that has been configured to back the locker  | 
