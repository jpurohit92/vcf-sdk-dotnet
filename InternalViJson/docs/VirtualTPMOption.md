# Vcenter.ViJson.OpenApi.Model.VirtualTPMOption
...
**SupportedFirmware** | **List&lt;string&gt;** | List of supported firmware selections, using *GuestOsDescriptorFirmwareType_enum* enumeration.  There is at least one value in this array.  | [optional] 
