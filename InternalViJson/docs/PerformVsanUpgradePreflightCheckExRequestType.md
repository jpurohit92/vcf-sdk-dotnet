# Vcenter.ViJson.OpenApi.Model.PerformVsanUpgradePreflightCheckExRequestType
...
------------ | ------------- | ------------- | -------------
**Cluster** | [**ManagedObjectReference**](ManagedObjectReference.md) | The target cluster to be converted.  ***Required privileges:*** Host.Config.Storage  Refers instance of *ClusterComputeResource*.  | 
