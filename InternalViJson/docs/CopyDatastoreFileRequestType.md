# Vcenter.ViJson.OpenApi.Model.CopyDatastoreFileRequestType
...
------------ | ------------- | ------------- | -------------
**SourceName** | **string** | The name of the source, either a URL or a datastore path referring to the file or folder to be copied.  | 
