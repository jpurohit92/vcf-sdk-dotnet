# Vcenter.ViJson.OpenApi.Model.VirtualDiskFlatVer1BackingOption
...
**WriteThrough** | [**BoolOption**](BoolOption.md) | Flag to indicate whether or not the host supports allowing the client to select \&quot;writethrough\&quot; as a mode for virtual disks.  Typically, this is available only for GSX Server Linux hosts.  | 
