# Vcenter.ViJson.OpenApi.Model.InvalidProfile
This exception is thrown if the specified storage profile is invalid.  This structure may be used only with operations rendered under `/sms`. 
