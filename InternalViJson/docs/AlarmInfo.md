# Vcenter.ViJson.OpenApi.Model.AlarmInfo
...
**Alarm** | [**ManagedObjectReference**](ManagedObjectReference.md) | The alarm object.  Refers instance of *Alarm*.  | 
**Entity** | [**ManagedObjectReference**](ManagedObjectReference.md) | The entity on which the alarm is registered.  Refers instance of *ManagedEntity*.  | 
**LastModifiedTime** | **DateTime** | The time the alarm was created or modified.  | 
**LastModifiedUser** | **string** | User name that modified the alarm most recently.  | 
**CreationEventId** | **int** | The event ID that records the alarm creation.  | 
