# Vcenter.ViJson.OpenApi.Model.VsanUpgradeSystemUpgradeHistoryStoragePoolOp
...
**Operation** | **string** | Storage pool disk operation like add, remove.  See also *VsanUpgradeSystemUpgradeHistoryDiskGroupOpType_enum*.  | 
**DiskInfo** | [**VimVsanHostStoragePoolDiskInfo**](VimVsanHostStoragePoolDiskInfo.md) | Storage pool disk info.  | 
