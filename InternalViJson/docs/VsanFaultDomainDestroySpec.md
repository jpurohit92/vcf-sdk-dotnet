# Vcenter.ViJson.OpenApi.Model.VsanFaultDomainDestroySpec
The specification to destroy a site fault domain.  This structure may be used only with operations rendered under `/vsan`. 
