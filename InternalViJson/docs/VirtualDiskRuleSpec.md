# Vcenter.ViJson.OpenApi.Model.VirtualDiskRuleSpec
...
**DiskRuleType** | **string** | Type of the virtual disks rule.  The set of possible values are described in *VirtualDiskRuleSpecRuleType_enum*  | 
**DiskId** | **List&lt;int&gt;** | The list of virtual disks for this rule.  | [optional] 
