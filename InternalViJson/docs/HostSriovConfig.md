# Vcenter.ViJson.OpenApi.Model.HostSriovConfig
...
**SriovEnabled** | **bool** | enable SR-IOV for this device  | 
**NumVirtualFunction** | **int** | Number of SR-IOV virtual functions to enable on this device  | 
