# Vcenter.ViJson.OpenApi.Model.HealthStatusChangedEvent
...
**ComponentId** | **string** | Unique ID of the VirtualCenter component.  | 
**OldStatus** | **string** | Previous health status of the component.  | 
**NewStatus** | **string** | Current health status of the component.  | 
**ComponentName** | **string** | Component name.  | 
**ServiceId** | **string** | Service Id of component.  | [optional] 
