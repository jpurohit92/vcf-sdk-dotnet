# Vcenter.ViJson.OpenApi.Model.IpAddressProfile
The *IpAddressProfile* represents the Virtual NIC IP address.  The *ApplyProfile.policy* property contains the configuration data values for the IP address. 
