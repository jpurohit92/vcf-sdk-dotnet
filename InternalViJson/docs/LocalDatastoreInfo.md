# Vcenter.ViJson.OpenApi.Model.LocalDatastoreInfo
...
**Path** | **string** | The local path on a host.  May not be available when the datastore is not accessible.  | [optional] 
