# Vcenter.ViJson.OpenApi.Model.VsanDiskGroupResourceCheckResult
...
**CacheTierDisk** | [**VsanDiskResourceCheckResult**](VsanDiskResourceCheckResult.md) | The detailed resource check result for the cache tier disk in the disk group.  | [optional] 
**CapacityTierDisks** | [**List&lt;VsanDiskResourceCheckResult&gt;**](VsanDiskResourceCheckResult.md) | The detailed resource check result for the capacity tier disks in the disk group.  | [optional] 
