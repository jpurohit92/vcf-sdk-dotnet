# Vcenter.ViJson.OpenApi.Model.VsanPerfDiagnoseRequestType
The parameters of *VsanPerformanceManager.VsanPerfDiagnose*.  This structure may be used only with operations rendered under `/vsan`. 
