# Vcenter.ViJson.OpenApi.Model.ProviderSyncFailed
Thrown if a failure occurs when synchronizing the service cache with provider information.  This structure may be used only with operations rendered under `/sms`. 
