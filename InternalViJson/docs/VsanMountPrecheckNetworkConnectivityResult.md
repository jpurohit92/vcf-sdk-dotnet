# Vcenter.ViJson.OpenApi.Model.VsanMountPrecheckNetworkConnectivityResult
...
**Details** | [**List&lt;VsanMountPrecheckNetworkConnectivityDetail&gt;**](VsanMountPrecheckNetworkConnectivityDetail.md) | A list of *VsanMountPrecheckNetworkConnectivityDetail*, it contains the network connectivity result for each client host to the server hosts it mounts to.  | [optional] 
