# Vcenter.ViJson.OpenApi.Model.CheckMigrateRequestType
...
------------ | ------------- | ------------- | -------------
**Vm** | [**ManagedObjectReference**](ManagedObjectReference.md) | The virtual machine we propose to migrate.  Refers instance of *VirtualMachine*.  | 
