# Vcenter.ViJson.OpenApi.Model.ActiveDirectoryProfile
The *ActiveDirectoryProfile* data object represents Active Directory configuration.  Use the *ApplyProfile.policy* list for access to configuration data for the Active Directory profile. Use the *ApplyProfile.property* list for access to subprofiles, if any. 
