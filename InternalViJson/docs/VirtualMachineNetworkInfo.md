# Vcenter.ViJson.OpenApi.Model.VirtualMachineNetworkInfo
...
**Network** | [**NetworkSummary**](NetworkSummary.md) | Information about the network  | 
**Vswitch** | **string** | Key of parent vSwitch of the network  | [optional] 
