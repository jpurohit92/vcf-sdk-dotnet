# Vcenter.ViJson.OpenApi.Model.VsanVdsMigrateVssRequestType
The parameters of *VsanVdsSystem.VsanVdsMigrateVss*.  This structure may be used only with operations rendered under `/vsan`. 

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Cluster** | [**ManagedObjectReference**](ManagedObjectReference.md) | Hosts of this cluster will be migrated to the new VDS  Refers instance of *ComputeResource*.  | 
**MigrationPlan** | [**VsanVdsMigrationPlan**](VsanVdsMigrationPlan.md) | Detailed migration plan  | [optional] 
