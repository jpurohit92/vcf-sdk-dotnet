# Vcenter.ViJson.OpenApi.Model.VlanProfile
The *VlanProfile* data object represents the VLAN identifier subprofile.  The *ApplyProfile.policy* property contains the configuration data values for the VLAN identifier. 
