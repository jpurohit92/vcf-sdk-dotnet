# Vcenter.ViJson.OpenApi.Model.NetworkProfileDnsConfigProfile
The *NetworkProfileDnsConfigProfile* data object represents DNS configuration for the host.  Use the *ApplyProfile.policy* list for access to configuration data for the DNS profile. Use the *ApplyProfile.property* list for access to subprofiles, if any. 
