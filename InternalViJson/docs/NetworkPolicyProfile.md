# Vcenter.ViJson.OpenApi.Model.NetworkPolicyProfile
The *NetworkPolicyProfile* data object represents a network policy.  The *ApplyProfile.policy* property contains network configuration data values. 
