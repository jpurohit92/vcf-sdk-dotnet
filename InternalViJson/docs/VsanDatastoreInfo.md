# Vcenter.ViJson.OpenApi.Model.VsanDatastoreInfo
...
**MembershipUuid** | **string** | The cluster membership identity of the datastore.  | [optional] 
**AccessGenNo** | **int** | The generation number tracking datastore accessibility.  | [optional] 
