# Vcenter.ViJson.OpenApi.Model.VsanUpgradeStatusEx
...
**IsPrecheck** | **bool** | Is or was this a precheck call, instead of a full upgrade.  | [optional] 
**PrecheckResult** | [**VsanDiskFormatConversionCheckResult**](VsanDiskFormatConversionCheckResult.md) | If this was a precheck that completed, then the result will be in this field.  | [optional] 
