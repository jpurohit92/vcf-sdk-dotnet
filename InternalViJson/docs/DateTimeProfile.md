# Vcenter.ViJson.OpenApi.Model.DateTimeProfile
The *DateTimeProfile* data object represents host date and time configuration.  Use the *ApplyProfile.policy* list for access to configuration data for the date and time profile. Use the *ApplyProfile.property* list for access to subprofiles, if any. 
