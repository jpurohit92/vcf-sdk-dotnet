# Vcenter.ViJson.OpenApi.Model.NsxHostVNicProfile
...
**IpConfig** | [**IpAddressProfile**](IpAddressProfile.md) | IP address for the Virtual NIC belonging to a logic switch.  | 
