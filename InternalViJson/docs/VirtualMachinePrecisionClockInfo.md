# Vcenter.ViJson.OpenApi.Model.VirtualMachinePrecisionClockInfo
...
**SystemClockProtocol** | **string** | The current host system clock synchronization protocol.  Used for specifying protocol in *VirtualPrecisionClockSystemClockBackingInfo*.  | [optional] 
