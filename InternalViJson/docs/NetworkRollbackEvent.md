# Vcenter.ViJson.OpenApi.Model.NetworkRollbackEvent
...
**MethodName** | **string** | Method name which caused the disconnect  | 
**TransactionId** | **string** | Transaction ID for the method call that caused the disconnect  | 
