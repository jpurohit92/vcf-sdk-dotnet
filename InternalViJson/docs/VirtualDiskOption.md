# Vcenter.ViJson.OpenApi.Model.VirtualDiskOption
...
**CapacityInKB** | [**LongOption**](LongOption.md) | Minimum, maximum, and default capacity of the disk.  | 
**IoAllocationOption** | [**StorageIOAllocationOption**](StorageIOAllocationOption.md) | Deprecated as of vSphere8.0 U3, and there is no replacement for it.  Minimum, maximum, and default values for Storage I/O allocation.  See also *StorageIOAllocationInfo*.  | 
**VFlashCacheConfigOption** | [**VirtualDiskOptionVFlashCacheConfigOption**](VirtualDiskOptionVFlashCacheConfigOption.md) | Deprecated since vSphere 7.0 because vFlash Read Cache end of availability.  vFlash cache configuration on the disk.  | [optional] 
