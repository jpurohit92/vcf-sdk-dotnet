# Vcenter.ViJson.OpenApi.Model.VirtualUSB
...
**Vendor** | **int** | Vendor ID of the USB device.  | [optional] 
**Product** | **int** | Product ID of the USB device.  | [optional] 
**Family** | **List&lt;string&gt;** | Device class families.  For possible values see *VirtualMachineUsbInfoFamily_enum*.  | [optional] 
**Speed** | **List&lt;string&gt;** | Device speeds detected by server.  For possible values see *VirtualMachineUsbInfoSpeed_enum*.  | [optional] 
