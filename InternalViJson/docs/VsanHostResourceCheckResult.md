# Vcenter.ViJson.OpenApi.Model.VsanHostResourceCheckResult
...
**Host** | [**ManagedObjectReference**](ManagedObjectReference.md) | The managed object of the host.  Unset if *EntityResourceCheckDetails.isNew* is true.  Refers instance of *HostSystem*.  | [optional] 
**DiskGroups** | [**List&lt;VsanDiskGroupResourceCheckResult&gt;**](VsanDiskGroupResourceCheckResult.md) | The detailed resource check result for disk groups on the host.  | [optional] 
**StoragePools** | [**List&lt;VsanStoragePoolResourceCheckResult&gt;**](VsanStoragePoolResourceCheckResult.md) | The detailed resource check result for the storage pool on the host.  | [optional] 
