# Vcenter.ViJson.OpenApi.Model.VirtualNVDIMM
...
**CapacityInMB** | **long** | NVDIMM backing size in MiB.  If backing is inaccessible, then capacity is reported as 0.  | 
**ConfiguredCapacityInMB** | **long** | NVDIMM device&#39;s configured size in MiB.  ***Since:*** vSphere API Release 7.0.2.0  | [optional] 
