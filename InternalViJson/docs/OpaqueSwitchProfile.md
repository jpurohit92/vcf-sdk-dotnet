# Vcenter.ViJson.OpenApi.Model.OpaqueSwitchProfile
The *OpaqueSwitchProfile* data object represents opaque switch configuration for the host.  If a profile plug-in defines policies or subprofiles, use the *ApplyProfile.policy* or *ApplyProfile.property* list to access the additional configuration data. 
