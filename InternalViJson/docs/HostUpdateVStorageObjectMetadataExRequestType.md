# Vcenter.ViJson.OpenApi.Model.HostUpdateVStorageObjectMetadataExRequestType
The parameters of *HostVStorageObjectManager.HostUpdateVStorageObjectMetadataEx_Task*.  ***Since:*** vSphere API Release 7.0.2.0 
