# Vcenter.Automation.OpenApi.Model.VcenterAuthorizationPermissionsIterationSpec
...
------------ | ------------- | ------------- | -------------
**PageSize** | **long** | Maximum number of records to return in one call. Clients can limit the response size to a number of records they feel comfortable handling with this setting. A service policy can overwrite it to something that is less than the value specified by the client.     This property was added in __vSphere API 9.0.0.0__.  If missing or &#x60;null&#x60; defaults to 200 permissions. | [optional] 
