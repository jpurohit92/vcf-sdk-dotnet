# Vcenter.Automation.OpenApi.Model.VcenterNamespaceManagementSupervisorsStorageCloudNativeResourceChecksGetParams
The Vcenter.NamespaceManagement.Supervisors.Storage.CloudNative.ResourceChecks.GetParams schema contains the parameters required to get the resource check result.  This schema was added in __vSphere API 9.1.0.0__.
