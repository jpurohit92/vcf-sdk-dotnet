# Vcenter.Automation.OpenApi.Model.VcenterComputePoliciesStatus
The Vcenter.Compute.Policies.Status schema describes the current status of a compute policy.  This schema was added in __vSphere API 7.0.3.0__.
