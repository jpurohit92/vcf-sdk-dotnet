# Vcenter.Automation.OpenApi.Model.EsxSettingsRepositorySoftwareDraftsAlternativeImagesComponentsUpdateSpec
The Esx.Settings.Repository.Software.Drafts.AlternativeImages.Components.UpdateSpec schema contains properties that are specified to update list of components of the alternative image.  This schema was added in __vSphere API 9.0.0.0__.
