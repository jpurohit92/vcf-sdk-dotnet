# Vcenter.Automation.OpenApi.Model.EsxHostsHostHardwareSpec
The Esx.Hosts.HostHardwareSpec schema contains properties to describe the host's hardware specifications like vendor, model, family and oem string.  This schema was added in __vSphere API 9.0.0.0__.
