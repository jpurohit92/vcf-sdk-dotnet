# Vcenter.Automation.OpenApi.Model.EsxSettingsInventoryReportsSummaryHostsApplyResult
The Esx.Settings.Inventory.Reports.Summary.Hosts.ApplyResult schema contains properties that describe the result of an apply operation.  This schema was added in __vSphere API 9.0.0.0__.
