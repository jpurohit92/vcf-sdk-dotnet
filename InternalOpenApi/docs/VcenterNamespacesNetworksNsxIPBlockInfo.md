# Vcenter.Automation.OpenApi.Model.VcenterNamespacesNetworksNsxIPBlockInfo
...
**Cidr** | [**VcenterNamespacesNetworksNsxIpv4Cidr**](VcenterNamespacesNetworksNsxIpv4Cidr.md) | IP block CIDR.  This property was added in __vSphere API 9.0.0.0__. | 
**Cidrs** | [**List&lt;VcenterNamespacesNetworksNsxIpv4Cidr&gt;**](VcenterNamespacesNetworksNsxIpv4Cidr.md) | A list of IP block CIDRs used to create the IP block. The IP block can be created with both CIDRs and ranges. CIDRs should not overlap with *Vcenter.Namespaces.Networks.Nsx.IPBlockInfo.ranges*.  This property was added in __vSphere API 9.1.0.0__.  This property is optional because it was added in a newer version than its parent node. | [optional] 
**Ranges** | [**List&lt;VcenterNamespacesNetworksNsxIPRange&gt;**](VcenterNamespacesNetworksNsxIPRange.md) | A list of IP block ranges used to create the IP block. The IP block can be created with both CIDRs and ranges. Ranges should not overlap with *Vcenter.Namespaces.Networks.Nsx.IPBlockInfo.cidrs*  This property was added in __vSphere API 9.1.0.0__.  This property is optional because it was added in a newer version than its parent node. | [optional] 
**AvailableIpRanges** | [**List&lt;VcenterNamespacesNetworksNsxIPRange&gt;**](VcenterNamespacesNetworksNsxIPRange.md) | Free IP ranges from CIDRs and ranges of the IP block.  This property was added in __vSphere API 9.0.0.0__. | 
**CidrUsages** | [**List&lt;VcenterNamespacesNetworksNsxCidrUsageDetails&gt;**](VcenterNamespacesNetworksNsxCidrUsageDetails.md) | Usage details for each CIDR of the IP block.  This property was added in __vSphere API 9.1.0.0__.  This property is optional because it was added in a newer version than its parent node. | [optional] 
**RangeUsages** | [**List&lt;VcenterNamespacesNetworksNsxRangeUsageDetails&gt;**](VcenterNamespacesNetworksNsxRangeUsageDetails.md) | Usage details for each range of the IP block.  This property was added in __vSphere API 9.1.0.0__.  This property is optional because it was added in a newer version than its parent node. | [optional] 
