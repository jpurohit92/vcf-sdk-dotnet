# Vcenter.Automation.OpenApi.Model.VcenterOvfOvfMessage
The Vcenter.Ovf.OvfMessage schema describes a base OVF handling error message related to accessing, validating, deploying, or exporting an OVF package.    These messages fall into different categories defined in *Vcenter.Ovf.OvfMessage.Category*:
