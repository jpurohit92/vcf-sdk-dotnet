# Vcenter.Automation.OpenApi.Model.VcenterPhmHardwareSupportManagersSetSpec
The Vcenter.Phm.HardwareSupportManagers.SetSpec schema provides a new hardware support manager registration data for replacing an existing registration entry, see *PUT /vcenter/phm/hardware-support-managers/{key}*.  This schema was added in __vSphere API 8.0.3.0__.
