# Vcenter.Automation.OpenApi.Model.VcenterDeploymentReplicatedSpec
The Vcenter.Deployment.ReplicatedSpec schema contains information used to check if the configuring vCenter Server can be replicated to the remote PSC.  This schema was added in __vSphere API 6.7__.
