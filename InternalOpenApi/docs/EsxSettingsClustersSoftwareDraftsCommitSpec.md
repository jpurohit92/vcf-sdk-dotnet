# Vcenter.Automation.OpenApi.Model.EsxSettingsClustersSoftwareDraftsCommitSpec
...
------------ | ------------- | ------------- | -------------
**Message** | **string** | Message to include with the commit.  This property was added in __vSphere API 7.0.0.0__.  If missing or &#x60;null&#x60;, message is set to empty string. | [optional] 
