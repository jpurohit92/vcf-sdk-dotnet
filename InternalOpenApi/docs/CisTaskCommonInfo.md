# Vcenter.Automation.OpenApi.Model.CisTaskCommonInfo
The Cis.Task.CommonInfo schema contains information common to all tasks.  This schema was added in __vSphere API 6.7__.
