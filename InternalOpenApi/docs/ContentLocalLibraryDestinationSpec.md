# Vcenter.Automation.OpenApi.Model.ContentLocalLibraryDestinationSpec
The Content.LocalLibrary.DestinationSpec schema contains information required to publish the library to a specific subscription.  This schema was added in __vSphere API 6.7.2__.
