# Vcenter.Automation.OpenApi.Model.VcenterCryptoManagerKmsProvidersFilterSpec
The Vcenter.CryptoManager.Kms.Providers.FilterSpec schema contains properties used to filter the results when listing providers.  This schema was added in __vSphere API 7.0.2.0__.
