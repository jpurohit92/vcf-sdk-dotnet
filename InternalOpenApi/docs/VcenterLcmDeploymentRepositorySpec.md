# Vcenter.Automation.OpenApi.Model.VcenterLcmDeploymentRepositorySpec
The Vcenter.Lcm.Deployment.Repository.Spec schema contains the repository configuration parameters.  This schema was added in __vSphere API 9.0.0.0__.
...
**Password** | **string** | The password used to authenticate with the repository,  This property was added in __vSphere API 9.0.0.0__.  Only set, when the repository requires authentication. | [optional] 
