# Vcenter.Automation.OpenApi.Model.VcenterTokenserviceInvalidRequest
The Vcenter.Tokenservice.InvalidRequest error indicates that *Vcenter.Tokenservice.TokenExchange.ExchangeSpec* is missing a required parameter, includes an unsupported parameter value (other than *Vcenter.Tokenservice.TokenExchange.ExchangeSpec.grant_type*)  This schema was added in __vSphere API 7.0.0.0__.
