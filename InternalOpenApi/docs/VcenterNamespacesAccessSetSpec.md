# Vcenter.Automation.OpenApi.Model.VcenterNamespacesAccessSetSpec
The Vcenter.Namespaces.Access.SetSpec schema contains the specification required to set new access control on the namespace.  This schema was added in __vSphere API 7.0.0.0__.
