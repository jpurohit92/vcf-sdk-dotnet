# Vcenter.Automation.OpenApi.Model.EsxSettingsHostsSoftwareExportSpec
...
------------ | ------------- | ------------- | -------------
**ExportSoftwareSpec** | **bool** | Whether to export software specification document.  This property was added in __vSphere API 8.0.0.1__. | 
**ExportIsoImage** | **bool** | Whether to export ISO image.  This property was added in __vSphere API 8.0.0.1__. | 
**ExportOfflineBundle** | **bool** | Whether to export offline bundle.  This property was added in __vSphere API 8.0.0.1__. | 
