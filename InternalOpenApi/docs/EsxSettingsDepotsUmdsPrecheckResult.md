# Vcenter.Automation.OpenApi.Model.EsxSettingsDepotsUmdsPrecheckResult
The Esx.Settings.Depots.Umds.PrecheckResult schema contains the fields that show the details of affected baselines and desired states found in *DELETE /esx/settings/depots/umds* operation.  This schema was added in __vSphere API 7.0.3.0__.
