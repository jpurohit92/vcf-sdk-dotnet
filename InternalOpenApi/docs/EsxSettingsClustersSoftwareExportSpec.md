# Vcenter.Automation.OpenApi.Model.EsxSettingsClustersSoftwareExportSpec
The Esx.Settings.Clusters.Software.ExportSpec schema contains information describing how a software specification or image should be exported.  This schema was added in __vSphere API 7.0.0.0__.

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**ExportSoftwareSpec** | **bool** | Whether to export software specification document.  This property was added in __vSphere API 7.0.0.0__. | 
**ExportIsoImage** | **bool** | Whether to export ISO image.  This property was added in __vSphere API 7.0.0.0__. | 
**ExportOfflineBundle** | **bool** | Whether to export offline bundle.  This property was added in __vSphere API 7.0.0.0__. | 
**ExportOnlyDefaultImage** | **bool** | Whether to export only default image.  This property was added in __vSphere API 9.0.0.0__.  This property is optional because it was added in a newer version than its parent node. | [optional] 
