# Vcenter.Automation.OpenApi.Model.VcenterNamespacesInstancesEdgeSetSpec
The Vcenter.Namespaces.Instances.EdgeSetSpec schema contains the specification required to associate the Edge provider with a vSphere Namespace.  This schema was added in __vSphere API 9.1.0.0__.
