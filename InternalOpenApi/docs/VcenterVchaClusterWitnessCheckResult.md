# Vcenter.Automation.OpenApi.Model.VcenterVchaClusterWitnessCheckResult
The Vcenter.Vcha.Cluster.Witness.CheckResult schema contains the warnings and errors that will occur during the clone operation.  This schema was added in __vSphere API 6.7.1__.
