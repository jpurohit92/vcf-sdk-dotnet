# Vcenter.Automation.OpenApi.Model.EsxSettingsHostsPoliciesApplyEffectiveEffectivePolicySpec
...
------------ | ------------- | ------------- | -------------
**FailureAction** | [**EsxSettingsHostsPoliciesApplyEffectiveFailureAction**](EsxSettingsHostsPoliciesApplyEffectiveFailureAction.md) | What action is to be taken if entering maintenance mode fails on an ESXi host.  This property was added in __vSphere API 8.0.0.1__. | 
