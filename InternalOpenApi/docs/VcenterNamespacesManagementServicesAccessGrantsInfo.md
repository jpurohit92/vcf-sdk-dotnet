# Vcenter.Automation.OpenApi.Model.VcenterNamespacesManagementServicesAccessGrantsInfo
...
------------ | ------------- | ------------- | -------------
**Description** | **string** | The description of the Access Grant.  This property was added in __vSphere API 9.1.0.0__.  If missing or &#x60;null&#x60;, the Access Grant has no description. | [optional] 
...
**WorkloadSelector** | [**VcenterNamespacesManagementServicesAccessGrantsWorkloadSelectorInfo**](VcenterNamespacesManagementServicesAccessGrantsWorkloadSelectorInfo.md) | Information on selection of workloads that are recipients of this grant.  This property was added in __vSphere API 9.1.0.0__. | 
