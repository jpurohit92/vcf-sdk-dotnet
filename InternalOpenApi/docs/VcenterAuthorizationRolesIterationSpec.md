# Vcenter.Automation.OpenApi.Model.VcenterAuthorizationRolesIterationSpec
The Vcenter.Authorization.Roles.IterationSpec schema contains properties used to break results into pages when listing roles, see *GET /vcenter/authorization/roles*).  This schema was added in __vSphere API 9.0.0.0__.

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**PageSize** | **long** | Maximum number of records to return in one call. Clients can limit the response size to a number of records they feel comfortable handling with this setting. A service policy can overwrite it to something that is less than the value specified by the client.     This property was added in __vSphere API 9.0.0.0__.  If missing or &#x60;null&#x60; defaults to 200 roles. | [optional] 
